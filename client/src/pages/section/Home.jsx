    ...
    >
      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-center gap-10 relative z-10 px-6">
        ...
        <div className="text-center md:text-left md:w-1/2 space-y-6">
          <motion.h1
            className="text-2xl lg:text-4xl xl:text-6xl font-bold text-gray-900"
          ...
          <motion.p
            className="text-md lg:text-lg xl:text-xl text-gray-700"
            initial={{ opacity: 0, x: -50 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 1, delay: 0.2 }}
          >
            {subheading || 
              `Get the tool you need built for free. Pay monthly
